 ...
 *   to ASPIRAS, WEIAM D. for Math 101. The solution is computed using cofactor
...
public class app {
    ...
    static int[][] matrix = {
        { 5, 2, 1 },   // Row 1 of assigned matrix
        { 3, 4, 2 },   // Row 2 of assigned matrix
        { 1, 2, 3 }    // Row 3 of assigned matrix
    };
    ...
    static void solveDeterminant(int[][] m) {
        ...
        System.out.println("  Student: ASPIRAS, WEIAM D.");
